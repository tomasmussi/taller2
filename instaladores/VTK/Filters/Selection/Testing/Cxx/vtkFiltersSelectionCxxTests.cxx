...
int TestLinearSelector2D(int, char*[]);
int TestCellDistanceSelector2D(int, char*[]);
int TestCellDistanceSelector3D(int, char*[]);
int TestLinearSelector3D(int, char*[]);
