...
int ImageAccumulateLarge(int, char*[]);
...
int ImageReslice(int, char*[]);
int ImageWeightedSum(int, char*[]);
int ImportExport(int, char*[]);
int TestBSplineWarp(int, char*[]);
int TestImageStencilDataMethods(int, char*[]);
int TestImageStencilIterator(int, char*[]);
int TestStencilWithLasso(int, char*[]);
...
static functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "TestImageStencilDataMethods",
    TestImageStencilDataMethods
  },
  {
    "TestImageStencilIterator",
    TestImageStencilIterator
  },
  {
    "TestStencilWithLasso",
    TestStencilWithLasso
  },
  {
    "TestStencilWithPolyDataContour",
    TestStencilWithPolyDataContour
  },
  {
    "TestStencilWithPolyDataSurface",
    TestStencilWithPolyDataSurface
  },
  {
