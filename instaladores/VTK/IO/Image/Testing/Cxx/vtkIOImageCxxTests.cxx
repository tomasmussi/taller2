...
int TestNrrdReader(int, char*[]);
int TestNIFTIReaderWriter(int, char*[]);
int TestNIFTIReaderAnalyze(int, char*[]);
int TestNIFTI2(int, char*[]);
int TestDataObjectIO(int, char*[]);
int TestMetaIO(int, char*[]);
int TestImportExport(int, char*[]);
int TestTIFFReaderMultiple(int, char*[]);
int TestTIFFReaderMultiple(int, char*[]);
int TestTIFFReaderMultiple(int, char*[]);
int TestTIFFReader(int, char*[]);
int TestTIFFReader(int, char*[]);
int TestTIFFReader(int, char*[]);
int TestCompressedTIFFReader(int, char*[]);
...
static functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "TestNIFTIReaderWriter",
    TestNIFTIReaderWriter
  },
  {
    "TestNIFTIReaderAnalyze",
    TestNIFTIReaderAnalyze
  },
  {
    "TestNIFTI2",
