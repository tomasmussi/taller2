...
int TestPDBBallAndStick(int, char*[]);
int TestBondColorModeDiscreteByAtom(int, char*[]);
...
int TestMoleculeSelection(int, char*[]);
int TestMoleculeMapperPropertyUpdate(int, char*[]);
int TestMultiCylinderOn(int, char*[]);
int TestMultiCylinderOff(int, char*[]);
int TestPeriodicTable(int, char*[]);
int TestProgrammableElectronicData(int, char*[]);
int TestProteinRibbon(int, char*[]);
int TestSimpleBondPerceiver(int, char*[]);
int TestVASPAnimationReader(int, char*[]);
int TestVASPTessellationReader(int, char*[]);
int TestVDWSpheres(int, char*[]);
int TestCMLMoleculeReader(int, char*[]);
...
static functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "TestBondColorModeDiscreteByAtom",
    TestBondColorModeDiscreteByAtom
  },
  {
    "TestBondColorModeSingleColor",
    TestBondColorModeSingleColor
  },
  {
    "TestCompositeRender",
  ...
  {
    "TestMoleculeIOLegacy",
    TestMoleculeIOLegacy
  },
  {
    "TestMoleculeSelection",
    TestMoleculeSelection
  },
  {
    "TestMoleculeMapperPropertyUpdate",
    TestMoleculeMapperPropertyUpdate
  },
  {
    "TestMultiCylinderOn",
  ...
  {
    "TestProgrammableElectronicData",
    TestProgrammableElectronicData
  },
  {
    "TestProteinRibbon",
  ...
  {
    "TestSimpleBondPerceiver",
    TestSimpleBondPerceiver
  },
  {
    "TestVASPAnimationReader",
    TestVASPAnimationReader
  },
  {
    "TestVASPTessellationReader",
    TestVASPTessellationReader
  },
  {
    "TestVDWSpheres",
