...
set_target_properties(vtkTestingRendering PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkTestingRendering-7.1.so.1"
  IMPORTED_SONAME_DEBUG "libvtkTestingRendering-7.1.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkTestingRendering )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkTestingRendering "${_IMPORT_PREFIX}/lib/libvtkTestingRendering-7.1.so.1" )
...
set_target_properties(vtkTestingGenericBridge PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkTestingGenericBridge-7.1.so.1"
  IMPORTED_SONAME_DEBUG "libvtkTestingGenericBridge-7.1.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkTestingGenericBridge )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkTestingGenericBridge "${_IMPORT_PREFIX}/lib/libvtkTestingGenericBridge-7.1.so.1" )
...
set_target_properties(vtkTestingIOSQL PROPERTIES
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/libvtkTestingIOSQL-7.1.so.1"
  IMPORTED_SONAME_DEBUG "libvtkTestingIOSQL-7.1.so.1"
  )

list(APPEND _IMPORT_CHECK_TARGETS vtkTestingIOSQL )
list(APPEND _IMPORT_CHECK_FILES_FOR_vtkTestingIOSQL "${_IMPORT_PREFIX}/lib/libvtkTestingIOSQL-7.1.so.1" )
