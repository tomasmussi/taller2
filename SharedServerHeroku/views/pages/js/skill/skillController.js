    ...
    $scope.skill = {
      ...
      category: "Ej: software",
        ...
        submit : function(){
            ...
            $http.post('http://localhost:5000/skills/categories/'+$scope.skill.category, data)
            .success(function (data, status, headers, config) {
                $scope.PostDataResponse = data;
                $window.location.href = 'http://localhost:5000';
            })
            .error(function (data, status, header, config) {
                $scope.skill.error="Error al guardar skill, por favor presione Reset y vuelva a intentar";
        ...
        edit : function(){
            ...
            $http.put('http://localhost:5000/skills/categories/'+$scope.categoryOld+'/'+$scope.nameOld, data)
            .success(function (data, status, headers, config) {
                $scope.PostDataResponse = data;
                $window.location.href = 'http://localhost:5000';
            })
        ...
        delete : function(){
            ...
            $http.delete('http://localhost:5000/skills/categories/'+$scope.categoryToDelete+'/'+$scope.nameToDelete,data)
            .success(function (data, status, headers, config) {
                
                $window.location.href = 'http://localhost:5000';
            })
            .error(function (data, status, header, config) {
                $scope.skill.error="Error al Borra skill, por favor presione Cancelar y vuelva a intentar";
                $scope.skill.errorState=true;
            });
        }
