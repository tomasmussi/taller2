...
function getAllJobPositions(req, res, next) {
  ...
  db.any('select jobpositions_name,jobpositions_description,category_name from job_positions')
    .then(function (data) {	
...
function getAllCategories(req, res, next) {
  ...
  db.any('select category_name,category_description from category')
    .then(function (data) { 
    logger.info('Respuesta OK: ' + JSON.stringify(data));
      res.status(200)
        .json({
...
function getAllSkills(req, res, next) {
  logger.info('Funcion getAllCategories');
  db.any('select skill_name,skill_description,category_name from skill')
    .then(function (data) { 
    logger.info('Respuesta OK: ' + JSON.stringify(data));
      res.status(200)
        .json({
