...
function getAllJobPositionsByCategory(req, res, next) {
    ...
    logger.info('category: '+req.params.name)
    if(data.length != 0){
...
function postJobPosition(req, res, next){
  ...
  logger.info('INSERT INTO job_position (name, description, category)VALUES (\''
  +req.body.name+
  '\',\''
  +req.body.description+
  '\',\''
...
function postskill(req,res,next){
  ...
  logger.info('INSERT INTO skill (name, description, category)VALUES (\''
  +req.body.name+
  '\',\''
  +req.body.description+
  '\',\''
...
function postCategory(req,res,next){
  ...
  logger.info('INSERT INTO skill (name, description)VALUES (\''
  +req.body.name+
  '\',\''
  +req.body.description+
  '\');');
