 ...
 */
public class JobsAdapter extends RecyclerView
        .Adapter<JobsAdapter
        .CourseHolder> {
    private static String LOG_TAG = "JobsAdapter";
    private ArrayList<LDJobPosition> mDataset;
    ...
    public JobsAdapter(ArrayList<LDJobPosition> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void addItem(LDJobPosition course, int index) {
