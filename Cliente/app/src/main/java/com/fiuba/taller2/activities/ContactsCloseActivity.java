...
import com.fiuba.taller2.adapters.ContactsCloseAdapter;
...
public class ContactsCloseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (coursesList != null) {
            mAdapter = new ContactsCloseAdapter(coursesList,this);
        } else {
            mAdapter = new ContactsCloseAdapter(new ArrayList<Contact>(),this);
        }
